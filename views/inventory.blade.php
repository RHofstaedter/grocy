...
<div class="row">
    <div class="col-12 col-md-6 col-xl-4 pb-3">
        ...
        <form id="inventory-form" novalidate>
            ...
            'additionalHtmlElements' => '<div id="inventory-change-info" class="form-text text-muted d-none ml-3 my-0 w-100"></div>',
            ...
            <div class="form-group">
                <label for="stock_label_type">
                    ...
                    <i class="fa-solid fa-question-circle text-muted" data-toggle="tooltip" data-trigger="hover click" title="{{ $__t('This will apply to added products') }}"></i>
                </label>
