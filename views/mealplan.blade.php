...
@section('content')
<script>
    var fullcalendarEventSources = {
        !!json_encode(array($fullcalendarEventSources)) !!
    };
    var internalRecipes = {
        !!json_encode($internalRecipes) !!
    };
    var recipesResolved = {
        !!json_encode($recipesResolved) !!
    };
    var weekRecipe = {
        !!json_encode($weekRecipe) !!
    };
    ...
    <div class="col">
        <div class="title-related-links">
            ...
            <div class="related-links collapse d-md-flex order-2 width-xs-sm-100 d-print-none" id="related-links">
                ...
                <a class="btn btn-outline-secondary m-1 mt-md-0 mb-md-0 float-right" href="{{ $U('/mealplansections') }}">
...
<div class="row">
    <div class="col">
        <div class="calendar" data-section-id="-1" data-section-name="" data-primary-section="true" data-last-section="true">
        </div>
    </div>
</div>
@endif
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="add-recipe-form" novalidate>
                    ...
                    <div class="form-group">
                        ...
                        <select class="custom-control custom-select" id="section_id_recipe" name="section_id_recipe" required>
            ...
            <div class="modal-footer">
                ...
                <button id="save-add-recipe-button" class="btn btn-success">{{ $__t('Save') }}</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="add-note-modal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="add-note-form" novalidate>
                    ...
                    <div class="form-group">
                        ...
                        <select class="custom-control custom-select" id="section_id_note" name="section_id_note" required>
                            @foreach($mealplanSections as $mealplanSection)
                            <option value="{{ $mealplanSection->id }}">{{ $mealplanSection->name }}</option>
                            @endforeach
                        </select>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">{{ $__t('Cancel') }}</button>
                <button id="save-add-note-button" class="btn btn-success">{{ $__t('Save') }}</button>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="add-product-form" novalidate>
                    ...
                    <div class="form-group">
                        <label for="period_type">{{ $__t('Section') }}</label>
                        <select class="custom-control custom-select" id="section_id_product" name="section_id_product" required>
                            @foreach($mealplanSections as $mealplanSection)
                            <option value="{{ $mealplanSection->id }}">{{ $mealplanSection->name }}</option>
                            @endforeach
                        </select>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">{{ $__t('Cancel') }}</button>
                <button id="save-add-product-button" class="btn btn-success">{{ $__t('Save') }}</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="copy-day-modal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">{{ $__t('Cancel') }}</button>
                <button id="save-copy-day-button" class="btn btn-primary">{{ $__t('Copy') }}</button>
            </div>
        </div>
    </div>
</div>
