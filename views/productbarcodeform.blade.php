        ...
        <form id="barcode-form" novalidate>
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    <input type="text" class="form-control barcodescanner-input" required id="barcode" name="barcode" value="@if($mode == 'edit'){{ $barcode->barcode }}@endif" data-target="#barcode">
            ...
            <div class="form-group">
                ...
                <select class="custom-control custom-select" id="shopping_location_id" name="shopping_location_id">
                    ...
                    <option @if($mode=='edit' && $store->id == $barcode->shopping_location_id) selected="selected" @endif value="{{ $store->id }}">{{ $store->name }}</option>
                    @endforeach
                </select>
            </div>
            @else
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="note" name="note" value="@if($mode == 'edit'){{ $barcode->note }}@endif">
            </div>
