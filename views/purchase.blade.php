    ...
    <div class="col-12 col-md-6 col-xl-4 pb-3">
        ...
        <form id="purchase-form" novalidate>
            ...
            <div class="custom-control custom-radio custom-control-inline mt-n2 mb-3">
                <input class="custom-control-input" type="radio" name="price-type" id="price-type-unit-price" value="unit-price" checked tabindex="-1">
                <label class="custom-control-label" for="price-type-unit-price">{{ $__t('Unit price') }}</label>
            </div>
            <div class="custom-control custom-radio custom-control-inline mt-n2 mb-3">
                <input class="custom-control-input" type="radio" name="price-type" id="price-type-total-price" value="total-price" tabindex="-1">
                <label class="custom-control-label" for="price-type-total-price">{{ $__t('Total price') }}</label>
            </div>
            ...
            <div class="form-group">
                ...
                <select class="custom-control custom-select" id="stock_label_type" name="stock_label_type">
                    <option value="0">{{ $__t('No label') }}</option>
                    <option value="1">{{ $__t('Single label') }}</option>
                    <option value="2">{{ $__t('Label per unit') }}</option>
                </select>
                <div id="stock-entry-label-info" class="form-text text-info"></div>
            </div>
            @endif
